...
void main(){
  ...
  void setUpMockHttpClientSuccess200(){
    ...
    async => http.Response(fixture('trivia.json'),200));
  }

  void setUpMockHttpClientFailure404(){
    when(mockHttpClient.get(any,headers: anyNamed('headers'))).thenAnswer((_)
    async => http.Response('Something went wrong',404));
  }
  ...
  group('getConcreteNumberTrivia', (){
    ...
    test('''should perform a GET request on a URL with number being the endpoint and
